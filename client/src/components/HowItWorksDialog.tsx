...
import { EXCHANGE_RATE, CURRENT_APY } from "@/lib/constants";
      ...
      <DialogContent className="sm:max-w-[425px] bg-[#1A1A1A] text-white border-cyan-500/20">
        <DialogHeader>
          ...
          <div className="space-y-4 text-sm text-gray-400">
            ...
            <DialogDescription>
              Initially, 1 boostDAI = {EXCHANGE_RATE} 1sDAI. This ratio gradually increases over time, which is how yield is generated. Your boostDAI balance remains constant, but its value in 1sDAI grows.
            </DialogDescription>
            <DialogDescription>
